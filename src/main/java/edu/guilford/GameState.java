...
public class GameState {
    // Use an enum for a game with initalizing, running, paused, and game over states
    public enum State {
    ...
    // Decalre a method of type State to hold the current game state 
    ...
    // Declare a constructor that initizalizes the gamne state to INITIALIZING
    public GameState() {
